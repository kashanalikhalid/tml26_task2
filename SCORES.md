...
| 12 | 25.05 ~12:23 | 1706 | exp12 multi-layer CKA (cka_layer2 + cka_layer3 + cka_layer4 + cka_avgpool aggregated) | **≤0.518** | unchanged at 49/56 | Multi-layer CKA brings same {169, 244, 295, 259} swap. **12 submissions all at 0.518.** Multi-layer representation similarity is not enough to find the 13 missed public-stolen models. |
| 13 | 25.05 ~13:27 | 1721 | **pure_lira_z** -- single LiRA feature shadow_target_specific_pred_match_z from exp14, used as raw score WITHOUT rank fusion. Range -24 to +95 sigma. | **0.592593 = 16/27** ⬆️ **+0.074** | **26/56 (up from 49/56)** | **BREAKTHROUGH.** Rank fusion was DILUTING the discriminative magnitude of the LiRA z-score. The pure single-feature, continuous (-24..+95) score puts stolen models far above the noise; the metric's FPR=5% threshold lands in a different region where ordering catches 2 more public-stolen than any ensemble. |
