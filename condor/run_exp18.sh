...
mkdir -p outputs/exp18
echo "::: [exp18] host=$(hostname)"
...
$PY -u experiments/exp18_sac.py \
    ...
    --features-out outputs/exp18/features.csv \
    --submission-out outputs/exp18/submission.csv
echo "::: done"; ls -la outputs/exp18/
